...
FROM recipes r,
(VALUES
    ('mise_en_place', 1, 'Start jasmine rice in rice cooker or saucepan (enough for 2 servings)', true, null),
    ('mise_en_place', 2, 'Peel and devein 1 lb shrimp if not already done, pat dry with paper towels', true, null),
    ('mise_en_place', 3, 'Slice 1 red bell pepper into thin strips', true, null),
    ('mise_en_place', 4, 'Drain 1 cup bamboo shoots', true, null),
    ('mise_en_place', 5, 'Pick Thai basil leaves from stems (about 1/2 cup)', true, null),
    ('mise_en_place', 6, 'Measure out 2 tbsp curry paste, 2 tbsp fish sauce, and 1 tbsp coconut sugar into small bowls', true, null),
    ('mise_en_place', 7, 'Shake coconut milk can well', false, 'Wash cutting board and knife. Wipe down counter.'),
    ('cooking', 1, 'Heat wok over medium-high heat, add 1/2 can coconut milk', true, null),
    ('cooking', 2, 'Stir constantly until coconut milk begins to separate and oil appears (2-3 min)', false, null),
    ('cooking', 3, 'Add 2 tbsp curry paste, stir for 1 minute until fragrant and well combined', true, null),
    ...
    ('cooking', 6, 'Add 1 cup bamboo shoots and sliced red bell pepper, simmer 2 minutes', true, null),
    ('cooking', 7, 'Add 1 lb shrimp, cook 5-7 minutes until pink and cooked through', true, null),
    ('cooking', 8, 'Stir in 2 tbsp fish sauce and 1 tbsp coconut sugar, taste and adjust', true, null),
    ('cooking', 9, 'Remove from heat, stir in Thai basil leaves', false, null),
    ('cooking', 10, 'Let rest 1 minute while basil wilts', false, null),
    ('plating', 1, 'Fluff rice and divide into 2 bowls', true, null),
